...
## [§](#vergen-gix---emit-cargo-instructions-from-a-build-script)vergen-gix - Emit cargo instructions from a build script
...
*   [DependencyKind](enum.DependencyKind.html "enum vergen_gix::DependencyKind")`cargo`
